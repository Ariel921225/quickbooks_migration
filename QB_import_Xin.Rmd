...
first_sheet <- read_excel("../2019_05_24_quickbooks.xlsx",sheet=1)

if(length(first_sheet)==0) {data<-read_xlsx("../2019_05_24_quickbooks.xlsx",sheet=2,col_names = FALSE)
} else{
  data<-first_sheet
}
...
data5<-subset(data2,data2$Amount==0,drop=FALSE)
data5$payment_method<-"in_kind"
all_data<-rbind(data3,data4,data5)
